...
.. class:: payments.dotpay.DotpayProvider(seller_id, pin[, channel=0, lock=False, lang='pl', endpoint='https://ssl.dotpay.pl/'])
   ...
   :param endpoint: The API endpoint to use. To test using staging environment, use ``'https://ssl.dotpay.pl/test_payment/'`` instead
